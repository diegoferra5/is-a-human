...
Top separators (by |effect size|):
  ...
  caller_formant_f1_std: human=198.864±40.551 synthetic=262.989±33.353 d=+1.73 [+1.13, +2.62] (synthetic > human)
  caller_formant_f2_std: human=198.864±40.551 synthetic=262.989±33.353 d=+1.73 [+1.13, +2.62] (synthetic > human)
...
split_rank_correlation=0.787
stable_top_features=caller_rms_mean, caller_zcr_std
bootstrap_runs=200

Logistic baseline (train on train, evaluate on val):
  train accuracy=0.872 f1=0.894 auc=0.922
  val   accuracy=0.887 f1=0.889 auc=0.967
