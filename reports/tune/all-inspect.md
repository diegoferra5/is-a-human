...
- accuracy **0.9575** · balanced acc **0.9535**
- TPR (synthetic) 0.9803 · TNR (human) 0.9267
- misses **15** (agree 5 · mixer picked wrong head 10)
- heads disagree 60 (mixer still right on 50)

## By split

- **train** acc 0.9574 · balanced 0.9513 · misses 12 / 282
...
| `call_bc7120020303` | train | human | 0.604 | 0.866 | 0.384 | miss_mixer | 1.450 | 0.494 | 0.887 |
| `call_bd2262567810` | train | human | 0.816 | 0.816 | 0.368 | miss_mixer | 1.730 | 0.537 | 0.920 |
...
| `call_bc7120020303` | 0.288 | 0.021 | 0.219 | 0.016 | 128.9 |
| `call_bd2262567810` | 0.307 | 0.029 | 0.246 | 0.017 | 103.8 |
